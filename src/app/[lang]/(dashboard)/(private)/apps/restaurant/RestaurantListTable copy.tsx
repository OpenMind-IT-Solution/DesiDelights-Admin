  ...
  const handleConfirmDelete = async () => {
    if (itemToDelete) {
      try {
        ...
        // await post(restaurantEndpoints.deleteRestaurant, { id: itemToDelete.id });
        console.log(`Successfully deleted restaurant with ID: ${itemToDelete.id}`)
