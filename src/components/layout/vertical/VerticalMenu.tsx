  ...
  return (
    ...
    >
      ...
      >
        ...
        <MenuItem href={`/${locale}/pages/misc/coming-soon`} icon={<i className='tabler-category-2' />}>
          {dictionary['navigation'].categoryManagement}
        </MenuItem>
        <MenuItem href={`/${locale}/pages/misc/coming-soon`} icon={<i className='tabler-menu-deep' />}>
